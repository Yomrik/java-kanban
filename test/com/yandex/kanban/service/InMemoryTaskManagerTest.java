...
class InMemoryTaskManagerTest {
    ...
    void addSubtask() {
        ...
        EpicTask epic1 = new EpicTask("Сделать БОЛЬШУЮ задачу №1", "БОЛЬШАЯ ЗАДАЧА №1", TypeTask.EPICTASK);
        taskManager.addEpic(epic1);
        Subtask subtask1 = new Subtask(StatusTask.NEW, "сделать маленькую задачу №1.1", "маленькая задача №1.1", epic1.getId(), TypeTask.SUBTASK);
        taskManager.addSubtask(subtask1);
        Subtask subtask2 = new Subtask(StatusTask.NEW, "сделать маленькую задачу №1.1", "маленькая задача №1.1", epic1.getId(), TypeTask.SUBTASK);
        subtask2.setId(2);
    ...
    void statusOfEpic() {
        ...
        Subtask subtask1 = new Subtask(StatusTask.NEW, "сделать маленькую задачу №1.1", "маленькая задача №1.1", epic1.getId(), TypeTask.SUBTASK);
        taskManager.addSubtask(subtask1);
        Subtask subtask2 = new Subtask(StatusTask.DONE, "сделать маленькую задачу №1.1", "маленькая задача №1.1", epic1.getId(), TypeTask.SUBTASK);
    ...
    void removeEpicAndRemoveSubtasksHystoryTest() {
        ...
        Subtask subtask2 = new Subtask(StatusTask.NEW, "сделать маленькую задачу №1.2", "маленькая задача №1.2", epic1.getId(), TypeTask.SUBTASK);
        subtask2.setId(3);
        subtask2.setType(TypeTask.SUBTASK);
